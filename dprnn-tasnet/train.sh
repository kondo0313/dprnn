...
wav_root="../../../dataset/all_10_2"
train_json_path="../../../dataset/all_10_2/train.json"
valid_json_path="../../../dataset/all_10_2/test.json"
...
--overwrite ${overwrite} \
--seed ${seed} \
--alpha ${alpha} | tee "${log_dir}/train_${time_stamp}.log"